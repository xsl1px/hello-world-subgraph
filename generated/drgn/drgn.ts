...
export class drgn extends ethereum.SmartContract {
  static bind(address: Address): drgn {
    return new drgn("drgn", address);
  }
  ...
  anailNathrachOrthaBhaisIsBeathaDoChealDeanaimh(
    ...
    let result = super.call(
      "anailNathrachOrthaBhaisIsBeathaDoChealDeanaimh",
      "anailNathrachOrthaBhaisIsBeathaDoChealDeanaimh(address[],uint256[]):(bool)",
      [
  ...
  try_anailNathrachOrthaBhaisIsBeathaDoChealDeanaimh(
    addresses: Array<Address>,
    values: Array<BigInt>
  ): ethereum.CallResult<boolean> {
    let result = super.tryCall(
...
export class AnailNathrachOrthaBhaisIsBeathaDoChealDeanaimhCall extends ethereum.Call {
  get inputs(): AnailNathrachOrthaBhaisIsBeathaDoChealDeanaimhCall__Inputs {
    return new AnailNathrachOrthaBhaisIsBeathaDoChealDeanaimhCall__Inputs(this);
  }

  get outputs(): AnailNathrachOrthaBhaisIsBeathaDoChealDeanaimhCall__Outputs {
    return new AnailNathrachOrthaBhaisIsBeathaDoChealDeanaimhCall__Outputs(
      this
    );
  }
}

export class AnailNathrachOrthaBhaisIsBeathaDoChealDeanaimhCall__Inputs {
  _call: AnailNathrachOrthaBhaisIsBeathaDoChealDeanaimhCall;

  constructor(call: AnailNathrachOrthaBhaisIsBeathaDoChealDeanaimhCall) {
    this._call = call;
  }
...
export class AnailNathrachOrthaBhaisIsBeathaDoChealDeanaimhCall__Outputs {
  _call: AnailNathrachOrthaBhaisIsBeathaDoChealDeanaimhCall;
